...
\replace{Replace this text with a brief summary of your experimental environment,
  including information about hardware, operating system and the language the tracker was implemented in.
Please also report the processing speed measured by the evaluation kit.}
