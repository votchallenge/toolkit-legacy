...
\def\iccvPaperID{****} % *** Enter the VOT2013 Paper ID here
...
%%%%%%%%% TITLE
\title{\LaTeX\ Author Guidelines for the VOT2013 Challenge Workshop}
...
By submitting a manuscript to VOT2013 the authors guarantee that it has
...
VOT2013 review period to {\bf any of the following}: another conference,
a workshop, or a journal. The authors also attest that they did not submit
substantially similar submissions to VOT2013. {\bf Violation of any of
...
(2)~argue in the body of your paper why your VOT2013 paper is non-trivially
different from these concurrent submissions, and (3)~include anonymized
versions of those papers in the supplemental material.

\subsection{Paper length}
VOT2013 papers may be up to 6 pages. 
...
the suitability of the paper for presentation in six pages if it is
reviewed in eleven.  
...
and you believe that the VOT2013 audience would like to hear about your
...
line 23)  
\begin{verbatim}
%\ifVOT2013final\pagestyle{empty}\fi
\setcounter{page}{4321}
\end{verbatim}
